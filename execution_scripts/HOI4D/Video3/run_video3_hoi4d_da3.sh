#!/bin/bash
# HOI4D Video3 - Training with DA3 depth predictions
# Purpose: Train EgoGaussian with DA3 metric depth (DA3 WINS STRONGLY on this video - 24% better MAE)
# Features: Full loss supervision with depth, RGB, and normal guidance
# Note: Video3 is a controlled scenario with clear hand manipulation - expect best results with DA3
...
python train_dynamic_depth.py \
  ...
  --port 6258 \
  --expname video3_EgoGaussian_background \
  --source_path "data/HOI4D/Video3/colmap" \
