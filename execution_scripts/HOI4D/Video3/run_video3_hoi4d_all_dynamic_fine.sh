...
python train_dynamic_depth.py \
  ...
  --configs "arguments/HOI4D/video3_all_dyn_fine.py" \
  --port 6257 \
  --expname video3_all_dynamic_importance_sampling \
  --source_path "data/HOI4D/Video3/colmap" \
  --start_checkpoint "/home/gperezsantamaria/sda_data/ICML_submission/Egocentric4DGaussians/output/video3_time_smoothed/chkpnt_dynamics_RGB_4100.pth" \
  --all_dynamic_on_fine \
  --black_background \