...
python train_dynamic_depth.py \
  ...
  --port 6258 \
  --expname video4_all_dynamic_fine \
  --source_path "data/HOI4D/Video4/colmap" \
  --start_checkpoint "/home/gperezsantamaria/sda_data/ICML_submission/Egocentric4DGaussians/output/video4_time_smoothed/chkpnt_dynamics_RGB_4100.pth" \
  --all_dynamic_on_fine \
