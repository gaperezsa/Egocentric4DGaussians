#!/bin/bash
# HOI4D Video4 - Training with DA3 depth predictions
# Purpose: Train EgoGaussian with DA3 metric depth (monst3r slightly better on this video)
# Features: Full loss supervision with depth, RGB, and normal guidance
# Note: This video shows monst3r advantages - good for comparative analysis
...
python train_dynamic_depth.py \
  ...
  --port 6259 \
  --expname video4_EgoGaussian_background \
