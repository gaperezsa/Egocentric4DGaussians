...
python train_dynamic_depth.py \
  ...
  --port 6251 \
  --expname video1_all_dynamic_fine_importance_sampling \
  --source_path "data/HOI4D/Video1/colmap" \
  --start_checkpoint "/home/gperezsantamaria/sda_data/ICML_submission/Egocentric4DGaussians/output/video1_time_smoothed/chkpnt_dynamics_RGB_4100.pth" \
  --all_dynamic_on_fine \
  --black_background \
