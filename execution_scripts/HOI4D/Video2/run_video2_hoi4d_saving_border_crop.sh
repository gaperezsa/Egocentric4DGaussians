...
python train_dynamic_depth.py \
  ...
  --port 6258 \
  --expname video2_border_crop_fine_best \
  --source_path "data/HOI4D/Video2/colmap" \
  --start_checkpoint "/home/gperezsantamaria/sda_data/ICML_submission/Egocentric4DGaussians/output_best_baselines/HOI4D/video2_border_crop_fine_no_depth_blaming/chkpnt_fine_coloring_10400.pth" \
  --all_dynamic_on_fine \
  --black_background \
