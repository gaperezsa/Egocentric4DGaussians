...
python train_dynamic_depth.py \
  ...
  --port 6257 \
  --expname video2_normals_with_gsplat_debug \
  --source_path "/home/gperezsantamaria/gperezsantamaria2/Egocentric4DGaussians/data/automatic_data_extraction_testing/with_monst3r/Video2/colmap"
