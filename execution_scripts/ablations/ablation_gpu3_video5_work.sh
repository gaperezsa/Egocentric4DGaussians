#!/bin/bash
# Ablation script for GPU 3: HOI4D Video5 + ADT work
...
# ====================================================================
# [1/4] HOI4D Video5 - Ablation: no chamfer stage (dynamics_depth_iterations=1)
# ====================================================================
echo "=========================================================="
echo "[1/4] HOI4D Video5 - no chamfer stage"
echo "=========================================================="
python train_dynamic_depth.py \
  ...
  --port 6282 \
  --expname ablation_video5_no_chamfer_stage \
  --source_path "data/HOI4D/Video5/colmap" \
  --start_checkpoint "output/ablation_video5_no_chamfer_stage/chkpnt_background_depth_10400.pth" \
  --all_dynamic_on_fine \
  --black_background

# ====================================================================
# [2/4] ADT work - Ablation: no chamfer stage (dynamics_depth_iterations=1)
# ====================================================================
echo "=========================================================="
echo "[2/4] ADT work - no chamfer stage"
echo "=========================================================="
python train_dynamic_depth.py \
  --batch_size 4 \
  ...
  --port 6283 \
  --expname ablation_work_no_chamfer_stage \
  --source_path "data/ADT/workV2/colmap"

# ====================================================================
# [3/4] HOI4D Video5 - Ablation: no depth/normal loss (weights set to 0)
# ====================================================================
echo "=========================================================="
echo "[3/4] HOI4D Video5 - no depth/normal loss"
echo "=========================================================="
python train_dynamic_depth.py \
  --batch_size 4 \
  --background_depth_iterations 10400 \
  ...
  --configs "arguments/HOI4D/video5_all_dyn_fine.py" \
  --port 6284 \
  --expname ablation_video5_no_depth_loss \
  --source_path "data/HOI4D/Video5/colmap" \
  --all_dynamic_on_fine \
  --black_background

# ====================================================================
# [4/4] ADT work - Ablation: no depth/normal loss (weights set to 0)
# ====================================================================
echo "=========================================================="
echo "[4/4] ADT work - no depth/normal loss"
echo "=========================================================="
python train_dynamic_depth.py \
  --batch_size 4 \
  --background_depth_iterations 20800 \
  ...
  --configs "arguments/ADT/fine_all_dyn.py" \
  --port 6285 \
  --expname ablation_work_no_depth_loss \
  --source_path "data/ADT/workV2/colmap"
