#!/bin/bash
# Ablation script for GPU 0: ADT clean  --  DRP (Depth Blame Pruning removed)
...
# ====================================================================
# ADT clean - Ablation: no depth blame pruning (DRP)
# ====================================================================
echo "=========================================================="
echo "ADT clean - no depth blame pruning (DRP)"
echo "=========================================================="
python train_dynamic_depth.py \
  ...
  --port 6291 \
  --expname ablation_true_clean_no_depth_blame_pruning \
