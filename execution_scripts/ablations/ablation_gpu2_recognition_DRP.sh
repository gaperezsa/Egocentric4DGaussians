#!/bin/bash
# Ablation script for GPU 2: ADT recognition  --  DRP (Depth Blame Pruning removed)
...
# ====================================================================
# ADT recognition - Ablation: no depth blame pruning (DRP)
# ====================================================================
echo "=========================================================="
echo "ADT recognition - no depth blame pruning (DRP)"
echo "=========================================================="
python train_dynamic_depth.py \
  ...
  --port 6295 \
  --expname ablation_true_recognition_no_depth_blame_pruning \
