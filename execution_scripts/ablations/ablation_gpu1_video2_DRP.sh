#!/bin/bash
# Ablation script for GPU 1: HOI4D Video2  --  DRP (Depth Blame Pruning removed)
...
# ====================================================================
# HOI4D Video2 - Ablation: no depth blame pruning (DRP)
# ====================================================================
echo "=========================================================="
echo "HOI4D Video2 - no depth blame pruning (DRP)"
echo "=========================================================="
python train_dynamic_depth.py \
  ...
  --port 6292 \
  --expname ablation_true_video2_no_depth_blame_pruning \
