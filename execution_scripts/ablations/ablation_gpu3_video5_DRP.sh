#!/bin/bash
# Ablation script for GPU 3: HOI4D Video5  --  DRP (Depth Blame Pruning removed)
...
# ====================================================================
# HOI4D Video5 - Ablation: no depth blame pruning (DRP)
# ====================================================================
echo "=========================================================="
echo "HOI4D Video5 - no depth blame pruning (DRP)"
echo "=========================================================="
python train_dynamic_depth.py \
  ...
  --port 6296 \
  --expname ablation_true_video5_no_depth_blame_pruning \
