#!/bin/bash
# Ablation script for GPU 0: HOI4D Video1 + ADT clean
...
# ====================================================================
# [1/4] HOI4D Video1 - Ablation: no chamfer stage (dynamics_depth_iterations=1)
# ====================================================================
echo "=========================================================="
echo "[1/4] HOI4D Video1 - no chamfer stage"
echo "=========================================================="
python train_dynamic_depth.py \
  ...
  --port 6270 \
  --expname ablation_video1_no_chamfer_stage \
  --source_path "data/HOI4D/Video1/colmap" \
  --start_checkpoint "output/ablation_video1_no_chamfer_stage/chkpnt_background_depth_10400.pth" \
  --all_dynamic_on_fine \
  --black_background

# ====================================================================
# [2/4] ADT clean - Ablation: no chamfer stage (dynamics_depth_iterations=1)
# ====================================================================
echo "=========================================================="
echo "[2/4] ADT clean - no chamfer stage"
echo "=========================================================="
python train_dynamic_depth.py \
  --batch_size 4 \
  ...
  --port 6271 \
  --expname ablation_clean_no_chamfer_stage \
  --source_path "data/ADT/cleanV2/colmap"

# ====================================================================
# [3/4] HOI4D Video1 - Ablation: no depth/normal loss (weights set to 0)
# ====================================================================
echo "=========================================================="
echo "[3/4] HOI4D Video1 - no depth/normal loss"
echo "=========================================================="
python train_dynamic_depth.py \
  --batch_size 4 \
  --background_depth_iterations 10400 \
  ...
  --configs "arguments/HOI4D/video1_all_dyn_fine.py" \
  --port 6272 \
  --expname ablation_video1_no_depth_loss \
  --source_path "data/HOI4D/Video1/colmap" \
  --all_dynamic_on_fine \
  --black_background

# ====================================================================
# [4/4] ADT clean - Ablation: no depth/normal loss (weights set to 0)
# ====================================================================
echo "=========================================================="
echo "[4/4] ADT clean - no depth/normal loss"
echo "=========================================================="
python train_dynamic_depth.py \
  --batch_size 4 \
  --background_depth_iterations 20800 \
  ...
  --configs "arguments/ADT/fine_all_dyn_importance_sampling.py" \
  --port 6273 \
  --expname ablation_clean_no_depth_loss \
  --source_path "data/ADT/cleanV2/colmap"
