#!/bin/bash
# Ablation script for GPU 1: HOI4D Video2 + ADT meal
...
# ====================================================================
# [1/4] HOI4D Video2 - Ablation: no chamfer stage (dynamics_depth_iterations=1)
# ====================================================================
echo "=========================================================="
echo "[1/4] HOI4D Video2 - no chamfer stage"
echo "=========================================================="
python train_dynamic_depth.py \
  ...
  --port 6274 \
  --expname ablation_video2_no_chamfer_stage \
  --source_path "data/HOI4D/Video2/colmap" \
  --start_checkpoint "output/ablation_video2_no_chamfer_stage/chkpnt_background_depth_10400.pth" \
  --all_dynamic_on_fine \
  --black_background

# ====================================================================
# [2/4] ADT meal - Ablation: no chamfer stage (dynamics_depth_iterations=1)
# ====================================================================
echo "=========================================================="
echo "[2/4] ADT meal - no chamfer stage"
echo "=========================================================="
python train_dynamic_depth.py \
  --batch_size 4 \
  ...
  --port 6275 \
  --expname ablation_meal_no_chamfer_stage \
  --source_path "data/ADT/mealV2/colmap"

# ====================================================================
# [3/4] HOI4D Video2 - Ablation: no depth/normal loss (weights set to 0)
# ====================================================================
echo "=========================================================="
echo "[3/4] HOI4D Video2 - no depth/normal loss"
echo "=========================================================="
python train_dynamic_depth.py \
  --batch_size 4 \
  --background_depth_iterations 10400 \
  ...
  --configs "arguments/HOI4D/video2_all_dyn_fine.py" \
  --port 6276 \
  --expname ablation_video2_no_depth_loss \
  --source_path "data/HOI4D/Video2/colmap" \
  --all_dynamic_on_fine \
  --black_background

# ====================================================================
# [4/4] ADT meal - Ablation: no depth/normal loss (weights set to 0)
# ====================================================================
echo "=========================================================="
echo "[4/4] ADT meal - no depth/normal loss"
echo "=========================================================="
python train_dynamic_depth.py \
  --batch_size 4 \
  --background_depth_iterations 20800 \
  ...
  --configs "arguments/ADT/fine_all_dyn_importance_sampling.py" \
  --port 6277 \
  --expname ablation_meal_no_depth_loss \
  --source_path "data/ADT/mealV2/colmap"
