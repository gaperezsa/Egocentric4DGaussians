#!/bin/bash
# Ablation script for GPU 2: HOI4D Video4  --  DRP (Depth Blame Pruning removed)
...
# ====================================================================
# HOI4D Video4 - Ablation: no depth blame pruning (DRP)
# ====================================================================
echo "=========================================================="
echo "HOI4D Video4 - no depth blame pruning (DRP)"
echo "=========================================================="
python train_dynamic_depth.py \
  ...
  --port 6294 \
  --expname ablation_true_video4_no_depth_blame_pruning \
