...
python train_dynamic_depth.py \
  ...
  --port 6263 \
  --expname work_all_dyn_no_DRP_on_fine \
  --start_checkpoint /home/gperezsantamaria/sda_data/ICML_submission/Egocentric4DGaussians/output/work_all_dyn/chkpnt_dynamics_RGB_4100.pth \
