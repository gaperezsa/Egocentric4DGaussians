...
python train_dynamic_depth.py \
  ...
  --port 6262 \
  --expname recognition_v3 \
  --source_path "data/ADT/recognitionV2/colmap" \
  --start_checkpoint /home/gperezsantamaria/sda_data/ICML_submission/Egocentric4DGaussians/output_best_baselines/ADT/recognition_v2/chkpnt_dynamics_RGB_4000.pth
