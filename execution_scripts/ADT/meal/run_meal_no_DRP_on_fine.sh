...
python train_dynamic_depth.py \
  ...
  --port 6261 \
  --expname meal_all_dyn_no_DRP_on_fine \
  --start_checkpoint /home/gperezsantamaria/sda_data/ICML_submission/Egocentric4DGaussians/output/meal_all_dyn/chkpnt_dynamics_RGB_4100.pth \
