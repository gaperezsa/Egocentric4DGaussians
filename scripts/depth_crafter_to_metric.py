...
def process_npz_and_depth_maps(npz_file_paths, depth_map_folder, metric_depth_crafter_output):
    ...
    for idx, npz_file in tqdm(enumerate(npz_file_paths)):
        ...
        start_idx = 0  # Index of the first corresponding depth map
        ...
        plt.legend()
        plt.savefig(f"/home/gperezsantamaria/gperezsantamaria_2/Egocentric4DGaussians/data/ADT/NewApartmentMealSeq137M1292_from_271000307556625_to_271013838726212/depth_crafter/scatter_npz_{idx+1}.png")
        plt.close()
        ...
        for i, map in enumerate(disparity_maps):
            ...
            predicted_depth = np.clip(func(disparity_map_resized_flat, *popt),10,None).reshape(disparity_map_resized.shape) #predict but do not allow preediction closer than 1 milimiters
            ...
            predicted_depth_img = Image.fromarray(predicted_depth.astype(np.int32), mode='I')
...
# Example usage
npz_file_paths = [
    '/home/gperezsantamaria/gperezsantamaria_2/Egocentric4DGaussians/data/ADT/NewApartmentMealSeq137M1292_from_271000307556625_to_271013838726212/depth_crafter/rgb_video.npz',
]
depth_map_folder = '/home/gperezsantamaria/gperezsantamaria_2/Egocentric4DGaussians/data/ADT/NewApartmentMealSeq137M1292_from_271000307556625_to_271013838726212/ADT_depth'
metric_depth_crafter_output = "/home/gperezsantamaria/gperezsantamaria_2/Egocentric4DGaussians/data/ADT/NewApartmentMealSeq137M1292_from_271000307556625_to_271013838726212/metric_depth_crafter_output"
